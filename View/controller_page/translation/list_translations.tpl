...
<form class="form-inline well ajax" method='POST' action="{$link_filter}">
	...
	<a class="btn btn-primary" href="#translation/edit_translation/">{t}Add{/t}</a>
	<a class="btn" href="#translation/import_translations">{t}Import{/t} &uarr;</a>
	<a class="btn" href="#translation/export_translations">{t}Export{/t} &darr;</a>
</form>
...
{if $arrData}
	<div class="list_wrap">
		...
		{include file="helpers/paginator.tpl" ajax_path="translation/list_translations"}
	</div>
{else}
