    <form class="form-horizontal json" action='{$form_action}' id='content_form' name='editform' method='post' enctype='multipart/form-data' style="margin: 0;">
        <div class="modal-header" style="height: 28px;">
            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
		{if $title}
            <h3 style="width:200px;float:left;">{$title}</h3>
		{/if}

			<ul class="nav nav-tabs tabs" style="float:left;">
	...
	{include file='helpers/messages.tpl'}
		...
		<div class="tabbed">
			...
			<div id="tabs-1">
				{include file='controller_page/edit.main_tab.tpl' modal=true}
				<div class="clear"></div>
			</div>
