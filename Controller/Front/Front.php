    ...
    public function abstractMain() {
        ...
        if($user->data['groupID']==2){
            ...
            if (function_exists('memory_get_peak_usage')) {
                $this->assign('memory_usage', round(memory_get_peak_usage() / 1024) . ' KB');
            }

            if($config->debug_mode){
                $this->assign('debug_console', bl_debug());
            }
        }
...
*/
	...
	public function loadRecursiveMenuBySelection($intSelectedNode) {
		$menu = new \Gratheon\CMS\Menu;
