...
class SAPE_client extends SAPE_base {
    ...
    function _get_db_file() {
        if ($this->_multi_site) {
            return $this->dir . '/' . $this->_host . '.links.db';
        } else {
            return $this->dir . '/links.db';
        }
    }
...
class SAPE_context extends SAPE_base {
    ...
    function _get_db_file() {
        if ($this->_multi_site) {
            return $this->dir . '/' . $this->_host . '.words.db';
        } else {
            return $this->dir . '/words.db';
        }
    }
...
class SAPE_articles extends SAPE_base {
    ...
    function _get_db_file(){
        if ($this->_multi_site){
            return $this->dir . '/' . $this->_host . '.' . $this->_save_file_name;
        }
        else{
            return $this->dir  . '/' . $this->_save_file_name;
        }
    }
